...
import { motsReservation, objetReservation } from './reservation-metier'
  ...
  return layout({
    ...
    body: `
      <div style="background:#FEF2F2;border-left:4px solid #DC2626;border-radius:10px;padding:14px 16px;margin-bottom:14px;">
        ...
        <p style="margin:6px 0 0;font-size:12px;color:#991B1B;">${mots.prestationLigne} : ${echapperHtml(prestation_nom) || '—'}</p>
      </div>
      ${(() => {
  ...
  return layout({
    ...
    body: `
      <div style="background:#F9FAFB;border-left:4px solid #6B7280;border-radius:10px;padding:14px 16px;margin-bottom:14px;">
        ...
        <p style="margin:0;font-size:14px;color:${C.ink};font-weight:600;">${echapperHtml(prestation_nom) || '—'}</p>
      </div>
  ...
  return layout({
    ...
    body: `
      <div style="background-color:${C.pale};background-image:linear-gradient(135deg,${C.bg} 0%,${C.pale} 100%);border-radius:14px;padding:18px 20px;border:1px solid ${C.main}22;margin-bottom:14px;">
        ...
        <p style="margin:6px 0 0;font-size:13px;color:${C.deep};font-weight:700;">${echapperHtml(prestation_nom) || '—'}</p>
