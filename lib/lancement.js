...
// Ce que touchera quelqu'un qui attend le lancement officiel pour s'inscrire.
//
// ⚠️ C'EST L'ARGUMENT DE VENTE, et il ne se raconte pas, il se compte. La date
// de fin ne bougeant pas, chaque jour d'attente est un jour de gratuité perdu :
// comparer `joursOfferts()` (aujourd'hui) à cette valeur rend l'urgence
// évidente sans qu'on ait à l'expliquer, et sans jamais forcer le trait.
