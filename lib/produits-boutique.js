...
// (STRIPE_PRICE_<envKey>_TEST / _LIVE). Comme les packs SMS et les abonnements,
// la vente se fait sur le compte PLATEFORME : les prix ci-dessous sont HTVA et
// servent à l'affichage, jamais au calcul du montant débité.
//
// 🔴 CE COMMENTAIRE DISAIT « la TVA est portée par le Price Stripe », ET C'ÉTAIT
// FAUX (corrigé le 20/09). Un Price ne porte aucune taxe tout seul, pas plus que
// `tax_id_collection` n'en facturait sur les abonnements. Le taux est posé sur
// chaque ligne de commande dans `app/api/accompagnement/checkout`, et il vient
// de `getStripeTaxRateId()`.
//
