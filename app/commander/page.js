...
function SplashScreen({ onDone }) {
  ...
  return (
    <div style={{
      ...
      <p style={{
        fontFamily: '"DM Sans", sans-serif', fontWeight: 900, fontSize: '3.5rem',
        color: '#fff', letterSpacing: '-2px', lineHeight: 1, marginBottom: 10,
      ...
      <p style={{
        ...
        color: '#C4A0F4', letterSpacing: '3px', textTransform: 'uppercase',
...
export default function Commander() {
  ...
  // Navigation vers la page commerçant
    ...
    <>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cats { display: flex; gap: 8px; overflow-x: auto; overflow-y: hidden; padding: 0 1rem 0.875rem; scrollbar-width: none; -ms-overflow-style: none; -webkit-overflow-scrolling: touch; }
