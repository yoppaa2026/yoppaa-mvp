...
// Exportee pour que la barre de progression de la landing parte de la MEME
// date d'annonce que la bascule teasing/reveal. Recopier la chaine
// d'environnement ailleurs, c'est se garantir qu'un jour les deux divergeront.
export function getRevealDateISO() {
  return revealDateStr()
}
