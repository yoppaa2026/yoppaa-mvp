...
/**
 * Combien de cartes avant « Voir les 9 ».
 *
 * ⚠️ ON DÉPLIE SUR PLACE, ON N'OUVRE PAS UNE PAGE (arbitrage Alex, 05/09). Une
 * page, c'est une route de plus, un retour de plus et un état de plus qui peut
 * casser ; le Yopper qui déplie est à UN clic de sa carte au lieu de deux
 * navigations. Et la liste est déjà bornée par le rayon.
 */
export const INVENDUS_AFFICHES = 4
