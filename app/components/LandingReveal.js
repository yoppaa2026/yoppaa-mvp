          ...
          <div style={{ display: 'flex', gap: 'clamp(24px, 5vw, 56px)', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: '1 1 340px', maxWidth: 460, display: 'flex', flexDirection: 'column', gap: 14 }}>
              {[
                ...
                { titre: 'Tes clients sont les tiens', texte: 'Tu vois qui commande chez toi, tu gardes leurs coordonnées, tu peux leur écrire directement. Yoppaa ne s’interpose jamais entre toi et ta clientèle : ce sont tes clients et tes données, tu en restes le responsable, et elles ne sont revendues à personne. Nos tarifs, nos frais et nos règles sont écrits noir sur blanc, la transparence est partout.' },
