      ...
      <div className="legal-layout" style={{ maxWidth: 900, margin: '0 auto', padding: '1.5rem', display: 'grid', gridTemplateColumns: '220px 1fr', gap: '2rem', alignItems: 'start' }}>
        ...
        <main style={{ background: '#fff', borderRadius: 16, border: `1.5px solid ${T.pale}`, padding: '2rem', boxShadow: '0 2px 12px rgba(107,53,196,0.07)' }}>
          ...
          <Section id="cgu-commercant" title="3. Conditions Générales d'Utilisation — Commerçants">
            ...
            <P><strong>Durée de l&rsquo;essai (offre de lancement).</strong> L&rsquo;essai prend fin à la plus tardive de ces deux dates : le <strong>8 janvier 2027 à 0h00 (heure de Bruxelles)</strong>, ou <strong>trente (30) jours après la création du compte</strong>. La gratuité couvre les journées comprises entre le jour de création du compte et la veille de la date de fin, celles-ci incluses ; la première facture est émise à la date de fin. À titre d&rsquo;exemple, un compte créé le 1er novembre 2026 bénéficie de 68 journées gratuites et reçoit sa première facture le 8 janvier 2027 ; un compte créé le 20 décembre 2026 bénéficie de 30 journées gratuites et reçoit sa première facture le 19 janvier 2027.</P>
