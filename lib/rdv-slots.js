...
import { creneauxDuJour, franchitMinuit, finApresMinuit } from './deplacement-rdv'
...
export { franchitMinuit, finApresMinuit }
...
export function conflitReservation({
  ...
  parCouverts = false, couvertsDemandes = 1,
}) {
...
export function genererSlots({ dateChoisie, dureeMinutes, creneaux, reservations, horairesDetail, capacite = 1, prestationId = null, liaisonsCreneaux = null, parCouverts = false, couvertsDemandes = 1 }) {
