...
import { motsReservation } from './reservation-metier'
  ...
  return layout({
    ...
    body: `
      ...
      <table style="width:100%;border-collapse:collapse;font-size:13px;background:#fff;border:1px solid ${C.pale};border-radius:12px;overflow:hidden;margin-bottom:14px;">
        <tr><td style="padding:10px 14px;color:${C.muted};border-bottom:1px solid ${C.pale};">${mots.prestationLigne}</td><td style="padding:10px 14px;color:${C.ink};font-weight:700;text-align:right;border-bottom:1px solid ${C.pale};">${echapperHtml(prestation_nom) || '—'}</td></tr>
      ...
      <p style="margin:0 0 14px;font-size:13px;line-height:1.6;color:${C.ink};">
        ${deplace
          ? `Rien d'autre ne change : même ${mots.prestation}, même prix, même référence 🟣`
  ...
  return layout({
    ...
    body: `
      <div style="background-color:${C.pale};background-image:linear-gradient(135deg,${C.bg} 0%,${C.pale} 100%);border-radius:14px;padding:18px 20px;border:1px solid ${C.main}22;margin-bottom:14px;">
        ...
        <p style="margin:8px 0 0;font-size:13px;color:${C.main};font-weight:800;">${echapperHtml(prestation_nom) || '—'}</p>
      </div>
      <table style="width:100%;border-collapse:collapse;font-size:13px;background:#fff;border:1px solid ${C.pale};border-radius:12px;overflow:hidden;margin-bottom:14px;">
