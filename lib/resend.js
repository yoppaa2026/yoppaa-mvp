...
export async function envoyerAuAdmin({ subject, html }) {
  return envoyer({ to: ADMIN_EMAIL, subject, html })
}

export async function envoyerAuCommercant({ to, subject, html }) {
    ...
    body: `
      <div style="background:${C.bg};border-radius:12px;padding:16px 18px;border:1px solid ${C.pale};">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:13px;">
          ...
          <tr><td style="padding:5px 0;color:${C.muted};">Score profil</td><td style="padding:5px 0;color:${score >= 80 ? '#16A34A' : score >= 60 ? '#EA580C' : '#DC2626'};font-weight:800;text-align:right;">${score} / 100</td></tr>
