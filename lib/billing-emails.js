...
function formatTarif(tarif) {
  ...
  // ⚠️ `euros()` ET NON UNE COPIE : celle-ci posait une espace ORDINAIRE, et
  // c'est précisément dans un email reçu sur téléphone qu'Alex a vu « 72,00 € »
  // se couper en fin de ligne, le « € » tombant seul en dessous du montant.
  // Trois fois dans le même ticket. La règle vit dans `lib/montants.js`.
  return euros(n)
}
