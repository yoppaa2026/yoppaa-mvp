...
// juste à savoir.
// ⚠️ `categorie` EST CELLE DU COMMERÇANT QUI REÇOIT LA NOTIFICATION, pas une
// donnée du bon : c'est son métier qui décide du mot, et lui seul lit ce push.
export function texteBonVendu(bon, categorie = null) {
  ...
  return {
    titre: `${libelleBon(categorie, { majuscule: true })} vendu 🟣`,
    corps: somme
