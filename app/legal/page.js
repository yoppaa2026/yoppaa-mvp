      ...
      <div className="legal-layout" style={{ maxWidth: 900, margin: '0 auto', padding: '1.5rem', display: 'grid', gridTemplateColumns: '220px 1fr', gap: '2rem', alignItems: 'start' }}>
        ...
        <main style={{ background: '#fff', borderRadius: 16, border: `1.5px solid ${T.pale}`, padding: '2rem', boxShadow: '0 2px 12px rgba(107,53,196,0.07)' }}>
          ...
          <Section id="cgu-commercant" title="3. Conditions Générales d'Utilisation — Commerçants">
            ...
            <P>Les paiements en ligne (acomptes RDV pour les vitrines, commandes Click &amp; Collect pour l&rsquo;alimentaire) sont traités via Stripe Connect Express en Direct Charge. L&rsquo;argent est versé directement sur le compte bancaire du Commerçant (sous 7 jours ouvrés). Les frais Stripe ({FRAIS_STRIPE_TEXTE}) sont supportés par le Commerçant et prélevés à la source par Stripe. Yoppaa ne prélève aucune commission sur les transactions.</P>
