        ...
        <main style={{ background: '#fff', borderRadius: 16, border: `1.5px solid ${T.pale}`, padding: '2rem', boxShadow: '0 2px 12px rgba(107,53,196,0.07)' }}>
          ...
          <Section id="cgu-commercant" title="3. Conditions Générales d'Utilisation — Commerçants">
            ...
            <Ul items={[
              ...
              'Vendre : 49,90€ HTVA/mois — tout Communiquer, plus Click & Collect avec paiement en ligne, rendez-vous en ligne, boutique en ligne avec expédition, livraison locale, programme de fidélité, assistant IA complet. Zéro commission Yoppaa sur les ventes, seuls les frais du prestataire de paiement s\'appliquent.',
            ]}/>
            <P>Les formules sont mensuelles, sans engagement de durée. Les formules payantes bénéficient d&rsquo;un essai gratuit, sans carte de paiement et sans reconduction obligatoire.</P>
            <P><strong>Durée de l&rsquo;essai (offre de lancement).</strong> L&rsquo;offre de lancement porte sur <strong>cent (100) jours à compter du 1er octobre 2026</strong>, date d&rsquo;ouverture publique de l&rsquo;application. La gratuité court donc <strong>jusqu&rsquo;au 8 janvier 2027 inclus</strong>, et la première facture est émise le <strong>9 janvier 2027</strong>.</P>
            <P>Un compte créé <strong>avant</strong> le 1er octobre 2026 bénéficie de ces cent jours <strong>ainsi que des journées séparant sa création du 1er octobre 2026</strong>, sans supplément de prix : la date de fin d&rsquo;essai reste le 9 janvier 2027 quelle que soit la date d&rsquo;inscription. Un compte créé <strong>après</strong> le 1er octobre 2026 bénéficie de la gratuité jusqu&rsquo;au 8 janvier 2027 inclus, et donc d&rsquo;une durée inférieure à cent jours.</P>
            <P><strong>Durée minimale garantie.</strong> Aucun essai ne peut être inférieur à <strong>trente (30) jours</strong>. Formellement, l&rsquo;essai prend fin à la plus tardive de ces deux dates : le 9 janvier 2027 à 0h00 (heure de Bruxelles), ou trente (30) jours après la création du compte. La gratuité couvre les journées comprises entre le jour de création du compte et la veille de la date de fin, celles-ci incluses ; la première facture est émise à la date de fin. À titre d&rsquo;exemple, un compte créé le 1er novembre 2026 bénéficie de 69 journées gratuites et reçoit sa première facture le 9 janvier 2027 ; un compte créé le 20 décembre 2026 bénéficie de 30 journées gratuites et reçoit sa première facture le 19 janvier 2027.</P>
            <P>Aucun moyen de paiement n&rsquo;est exigé pendant l&rsquo;essai. Le Commerçant peut résilier à tout moment avant la date de fin de l&rsquo;essai sans qu&rsquo;aucune somme ne soit due. La date de fin d&rsquo;essai propre à chaque compte est affichée dans l&rsquo;espace commerçant, rubrique Abonnement.</P>
            ...
            <P>Les paiements en ligne (acomptes RDV pour les vitrines, commandes Click &amp; Collect pour l&rsquo;alimentaire) sont traités via Stripe Connect Express en Direct Charge. L&rsquo;argent est versé directement sur le compte bancaire du Commerçant (sous 7 jours ouvrés). Les frais Stripe (à partir de 1,5% + 0,25€ par transaction pour une carte européenne standard, davantage pour une carte premium ou étrangère) sont supportés par le Commerçant et prélevés à la source par Stripe. Yoppaa ne prélève aucune commission sur les transactions.</P>
