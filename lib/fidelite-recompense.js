 ...
 */
export function libelleAutresRecompenses(total, contexte = 'commande', commercant = null) {
  ...
  // le texte d'avant à la lettre près.
  const mots = motsReservation(commercant)
  if (reste === 1) {
    return `Il t’en reste 1 autre : elle te sera proposée à ${estRdv ? mots.prochaineFois : 'ta prochaine commande'}.`
  }
  ...
  return `Il t’en reste ${reste} autres : elles te seront proposées une par une, à ${estRdv ? mots.prochainesFois : 'tes prochaines commandes'}.`
}
