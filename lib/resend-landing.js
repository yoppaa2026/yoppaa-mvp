  ...
  return layout({
    ...
    body: `
      ...
      <div style="margin:0 0 18px;padding:16px 18px;border-radius:14px;background:${C.bg};border:1px solid ${C.pale};">
        ...
        <p style="margin:0 0 6px;font-size:13.5px;line-height:1.6;color:${C.ink};">Yoppaa ne prend aucune commission sur tes ventes, une formule gratuite pour toujours, et 30 jours d'essai sur les formules payantes.</p>
