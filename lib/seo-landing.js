...
import { LAUNCH_DATE_ISO, FIN_ESSAI_LANCEMENT_ISO, libelleFinEssaiLancement, estRegimeLancement } from './lancement'
...
function offreFormule(plan, position, maintenant = new Date()) {
  ...
  return {
    ...
    description: prix.mensuel > 0 && gratuite
      ? `${DESCRIPTIONS[plan]} Offert jusqu'au ${libelleFinEssaiLancement()}, sans carte de paiement.`
      : DESCRIPTIONS[plan],
    position,
    ...
    ...(prix.mensuel > 0 && gratuite
      ? { priceValidUntil: FIN_ESSAI_LANCEMENT_ISO.slice(0, 10) }
      : {}),
  }
}
  ...
  return {
    ...
    '@graph': [
      ...
      },
      {
        ...
        inLanguage: 'fr-BE',
        description: "L'app belge des commerces de quartier : Click and Collect, rendez-vous en ligne, deals du jour, carte de fidélité et bons cadeaux, commune par commune.",
