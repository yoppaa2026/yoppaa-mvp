...
// ─── UNE HEURE DE PENDULE, LUE ET ÉCRITE ────────────────────────────────────
//
// ⚠️ CES DEUX-LÀ VIENNENT DE `lib/anti-gaspi.js`, POUR LA MÊME RAISON QUE LES
// PRÉCÉDENTES. Le module des délais de commande lit les heures de créneau et
// les écrit à l'écran ; les recopier aurait fabriqué deux façons de lire
// « 09:30 » et deux typographies de « 9 h 30 ». Elles sont réexportées par
// `anti-gaspi.js`, donc aucun appelant existant ne bouge.
...
/**
 * L'heure telle qu'on l'écrit chez nous.
 *
