...
// ⚠️ `commercant` EST FACULTATIF, et son absence garde le mot du rendez-vous :
// les appelants qui ne l'ont pas sous la main ne changent pas de comportement.
export function texteAlerteRdv(rdv, { aujourdhui, demain, commercant = null } = {}) {
  const mots = motsReservation(commercant)
  if (!rdv) return { titre: mots.alerteSansObjet, corps: '' }
