...
// signature est précisément la partie qu'il faut pouvoir éprouver. Elle vit
// ici, pure, et `lib/yopper-session.js` l'utilise.
//
// 🔴 CE QU'ELLE N'EMPÊCHE PAS (corrigé le 15/09 : cette phrase disait le
// contraire). Elle empêche de MODIFIER un cookie que nous avons émis. Elle
// n'empêche pas de se faire passer pour quelqu'un d'autre : le serveur signe
// l'identité qu'on lui déclare. Un cookie signé n'est donc jamais une preuve,
// et aucune route ne s'y fie (voir `lib/yopper-session.js`).
//
