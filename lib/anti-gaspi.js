...
// c'est la POUBELLE. Le poissonnier qui ne peut pas faire moitié prix sur un
// plateau à 40 € jettera. Un plancher trop haut produit du gaspillage, ce qui
// est exactement l'inverse du but.
export const REMISE_MINIMALE = 50
...
export function fenetreOuverte(offre, instant = new Date()) {
  const debut = minutesDeLHeure(offre?.heure_debut)
