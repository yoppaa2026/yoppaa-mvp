...
export function lignesAvantages(C, { fidelite_remise = 0, bon_cadeau_montant = 0 } = {}) {
  ...
  const ligne = (libelle, couleur, valeur) => `<tr>
        ...
        <td style="padding:10px 14px;color:${couleur};font-size:13px;font-weight:800;text-align:right;border-bottom:1px solid ${C.pale};">−${valeur.toFixed(2)} €</td>
      </tr>`
  ...
  return layout({
    ...
    body: `
      ...
      <table style="width:100%;border-collapse:collapse;font-size:13px;background:#fff;border:1px solid ${C.pale};border-radius:12px;overflow:hidden;margin-bottom:14px;">
        ...
        ${prix_estime != null ? `<tr><td style="padding:10px 14px;color:${C.muted};border-bottom:1px solid ${C.pale};">Prix</td><td style="padding:10px 14px;color:${C.main};font-weight:900;text-align:right;border-bottom:1px solid ${C.pale};">${Number(prix_estime).toFixed(2)} €</td></tr>` : ''}
