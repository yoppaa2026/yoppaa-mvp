  ...
  return layout({
    ...
    body: `
      ...
      <div style="margin:0 0 18px;padding:16px 18px;border-radius:14px;background:${C.bg};border:1px solid ${C.pale};">
        ...
        <p style="margin:0;font-size:12.5px;line-height:1.6;color:${C.muted};">Sur les paiements en ligne, seuls les frais de Stripe, notre prestataire de paiement, s'appliquent : environ 1,4 % + 0,25 € par transaction pour une carte européenne.</p>
        ` : `
