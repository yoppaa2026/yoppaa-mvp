...
## ⚠️ CE GABARIT SERT LES DEUX PUBLICS, ET C'EST SA CONTRAINTE PRINCIPALE

`app/signup/page.js` (commerçant) et `app/commander/auth/page.js` (Yopper)
appellent **tous les deux** `supabase.auth.signUp`. Il n'existe qu'un seul
gabarit « Confirm signup » : un habitant qui crée son compte pour commander une
pizza reçoit **exactement le même email** qu'un commerçant.

Sont donc bannis de ce texte : *facture*, *fiche*, *validation*, *notre équipe*,
*ton commerce*, *tableau de bord*. Chacun de ces mots serait faux une fois sur
deux. La mention de pied de page dit « tu utilises Yoppaa », vrai des deux côtés.

⚠️ Ce qui distingue les deux, c'est **le lien**, et lui seul : `.RedirectTo`
ramène le commerçant sur `/signup` et le Yopper sur `/commander`.
...
<body style="margin:0;padding:0;background:#F8F6FF;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;color:#1A0840;">
  <div style="max-width:560px;margin:0 auto;padding:24px 16px;">
    ...
    <div style="background:#fff;border-radius:0 0 18px 18px;padding:28px;border:1px solid #EDE0FF;border-top:none;">
      <p style="margin:0 0 18px;font-size:15px;line-height:1.55;color:#1A0840;">Il reste un clic, et ton compte Yoppaa est ouvert. 🟣</p>
      
      <p style="margin:0 0 16px;font-size:14px;line-height:1.6;color:#1A0840;">
        On vérifie simplement que cette adresse est bien la tienne : c’est elle qui
        te connecte, et c’est là qu’arriveront tes confirmations.
      </p>
      <div style="background:#F8F6FF;border-radius:12px;padding:14px 16px;border:1px solid #EDE0FF;margin-bottom:6px;">
        <p style="margin:0;font-size:12.5px;color:#2D0F6B;line-height:1.6;">
          <strong>Le lien te ramène là où tu t’es arrêté</strong>, avec ce que tu avais
          déjà rempli. Tu n’as rien à ressaisir.
        </p>
      </div>
    ...
    <p style="margin:18px 0 0;text-align:center;font-size:11px;color:#6B7280;">
      yoppaa.app · Ton quartier dans ta poche<br/>Tu reçois cet email parce que tu utilises Yoppaa.
    </p>
  </div>
</body>
</html>
