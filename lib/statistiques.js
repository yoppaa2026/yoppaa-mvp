...
// des produits et celle des prestations. Un salon qui vend trois shampoings
// par mois et vingt coupes doit voir lequel des deux le fait vivre.
export function chiffreAffaires(commandes = [], rdvs = []) {
  ...
  const encaisseEnLigne = produits + acomptes
  return {
    total: arrondi(produits + prestations),
    ...
    encaisse_en_ligne: arrondi(encaisseEnLigne),
    au_comptoir: arrondi(prestations - acomptes),
