...
import { estFoodTruck } from './types-commerce.js'
...
export function metierPhotos({ categorie, type } = {}) {
  // Même détection que la fiche et le tableau de bord : elle vit dans
  // `lib/types-commerce.js`, et c'est la seule qui fasse foi.
  if (estFoodTruck(type)) return 'foodtruck'
