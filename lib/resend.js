        ...
        <p style="margin:0 0 8px;font-size:12px;color:#7C2D12;line-height:1.5;">
          Tu peux annuler ${mots.laSienne} gratuitement jusqu'à <strong>${delai_annulation_heures}h</strong> avant ton créneau. ${
            ...
            (Number(fidelite_remise) > 0 || Number(bon_cadeau_montant) > 0)
              ? `Ton acompte revient sur ton moyen de paiement en 5 à 10 jours, et ${Number(nb_bons) > 1 ? 'tes' : 'ton'} ${libelleBon(commercant_categorie, { pluriel: Number(nb_bons) > 1 })} comme ta récompense retournent chez toi, utilisables tout de suite.`
              : 'Remboursement automatique de l\'acompte en 5 à 10 jours.'
          }
        </p>
