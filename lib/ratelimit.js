...
// Formulaires écrits à la main (suggestion d'un commerce, signalement d'une
// fiche) : 5 envois / 10 min par IP. Un habitant qui remplit quatre champs en
// dépasse rarement un ; un robot en poste mille.
//
// ⚠️ DEPUIS LE 08/09, CHACUN DÉCLENCHE UN EMAIL vers l'administration. Sans
// cette borne, le robinet du spam devient un robinet dans une boîte mail. Elle
// s'applique aux deux FORMULAIRES seulement : les envies sont des clics, et un
// Yopper peut légitimement en envoyer cinq d'affilée sur une même fiche.
export const formulairesLimiter = makeLimiter(Ratelimit.slidingWindow(5, '600 s'), 'rl:form')
