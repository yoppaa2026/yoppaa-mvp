  ...
  if (mode_landing === 'teasing') {
    return layout({
      ...
      body: `
        ...
        <p style="margin:0 0 16px;font-size:15px;line-height:1.65;color:${C.ink};">
          Je construis quelque chose à Mettet depuis plusieurs mois. Un projet belge, ancré, qui prendra sa pleine forme le <strong style="color:${C.main};">21 juillet 2026</strong>.
        </p>
        <p style="margin:0 0 16px;font-size:15px;line-height:1.65;color:${C.ink};">
...
// Email envoye le 21 juillet 9h aux pre-inscrits Teasing : le grand reveal.
